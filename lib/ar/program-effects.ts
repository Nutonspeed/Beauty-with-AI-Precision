/**
 * Real-time AR Program Effects
 * Canvas-based image filters for program simulation
 */
 ...
 */
export const botoxEffect: ProgramEffect = {
  name: 'Botox',
 ...
 */
export const fillerEffect: ProgramEffect = {
  name: 'Filler',
  apply: (ctx, imageData, intensity, landmarks) => {
    const data = imageData.data
    const width = imageData.width
 ...
 */
export const laserEffect: ProgramEffect = {
  name: 'Laser',
 ...
 */
export const peelEffect: ProgramEffect = {
  name: 'Chemical Peel',
  apply: (ctx, imageData, intensity) => {
    const data = imageData.data
    const width = imageData.width
 ...
 */
export const microneedlingEffect: ProgramEffect = {
  name: 'Microneedling',
  apply: (ctx, imageData, intensity) => {
    const data = imageData.data
 ...
 */
export const threadLiftEffect: ProgramEffect = {
  name: 'Thread Lift',
...
/**
 * Get all program effects
 */
export const programEffects: Record<ProgramType, ProgramEffect | null> = {
  botox: botoxEffect,
  filler: fillerEffect,
  laser: laserEffect,
  peel: peelEffect,
