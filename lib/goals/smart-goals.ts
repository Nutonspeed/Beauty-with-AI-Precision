    ...
    switch (concern.type) {
      ...
      case 'dark_spots':
        goals.push(this.createGoalTemplate({
          ...
          description: 'Reduce visibility of hyperpigmentation through brightening programs',
      ...
      case 'fine_lines':
        goals.push(this.createGoalTemplate({
          ...
          description: 'Reduce appearance of wrinkles through retinoid use and anti-aging programs',
