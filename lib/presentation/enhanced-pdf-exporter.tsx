...
const TRANSLATIONS = {
  en: {
    ...
    month: 'Month',
    // Footer
    disclaimer: 'This report is generated by AI-powered skin analysis. Results should be confirmed by a licensed professional.',
  ...
  th: {
    ...
    // Program
    recommendedPrograms: 'โปรแกรมที่แนะนำ',
    programPlan: 'แผนงานดูแลผิว',
    programTimeline: 'ไทม์ไลน์โปรแกรม',
    duration: 'ระยะเวลา',
    sessions: 'จำนวนครั้ง',
    ...
    month: 'เดือน',
    // Footer
    disclaimer: 'รายงานนี้สร้างจากการวิเคราะห์ด้วย AI ควรได้รับการยืนยันจากผู้เชี่ยวชาญ',
...
export class EnhancedPDFExporter {
  ...
  public async generate(
    ...
    if (options.programPackages && options.programPackages.length > 0) {
      this.totalPages += 1; // Program recommendations
      if (options.includeTimeline) {
        this.totalPages += 1; // Program timeline
      }
    }
    ...
    // Program recommendations (if provided)
    // TODO: Add program pages when needed
