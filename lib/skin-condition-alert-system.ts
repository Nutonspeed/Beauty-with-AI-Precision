  ...
  private static checkThresholdAlerts(
    ...
    if (currentScore < previousScore && changeAmount >= rule.thresholdImprovement) {
      ...
      alerts.push({
        ...
        recommendedAction: 'Continue your current program regimen to maintain these results',
        isRead: false,
  ...
  private static analyzeTrends(
    ...
    if (consistentTrend && trendDirection === 'worsening' && trendMagnitude > rule.thresholdDegradeation) {
      alerts.push({
        ...
        recommendedAction: 'We recommend scheduling a consultation to adjust your program plan',
        isRead: false,
        shouldNotify: true,
        targetAudience: 'both',
      });
      ...
      alerts.push({
        ...
        recommendedAction: 'Your current program plan is working well! Keep up the routine',
        isRead: false,
        shouldNotify: false,
        targetAudience: 'customer',
      });
    ...
    if (zScore > standardDeviations) {
      ...
      alerts.push({
        ...
        recommendedAction: isPositiveAnomaly
          ...
          : 'Please consult with your specialist to ensure your program is still appropriate',
        isRead: false,
