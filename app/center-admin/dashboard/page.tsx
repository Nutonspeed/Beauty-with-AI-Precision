...
// ============================================================================
// Phase 5: Center Admin Dashboard - Main Dashboard Page
// Purpose: Display comprehensive dashboard overview for center administrators
// ============================================================================
...
import type { GetDashboardStatsResponse } from '@/types/center-admin'
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Latest actions in your center</CardDescription>
      </CardHeader>
      <CardContent>
...
export default function CenterDashboardPage() {
  ...
  useEffect(() => {
    async function fetchDashboardData() {
      try {
        setLoading(true)
        const response = await fetch(`/api/center/dashboard/stats?days=${chartDays}`)
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Most popular programs this period</CardDescription>
          </CardHeader>
          <CardContent>
