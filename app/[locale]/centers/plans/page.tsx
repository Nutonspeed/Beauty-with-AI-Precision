...
const plans = [
  {
    ...
    name: 'Basic',
    highlight: false,
    description: 'สำหรับศูนย์ความงามที่ต้องการเริ่มทดลองใช้ AR / AI กับทีมเซล 1 คน',
    price: 'สอบถามแพ็กเกจ',
    badge: 'เริ่มต้น',
    maxSalesUsers: 1,
    features: [
  ...
  },
  {
    ...
    name: 'Pro',
    highlight: true,
    description: 'สำหรับศูนย์ความงามที่มีทีมเซลหลายคน ต้องการดันยอดขายด้วย AR / AI แบบจริงจัง',
    price: 'แพ็กเกจแนะนำ',
    badge: 'ยอดนิยม',
    maxSalesUsers: 3,
    features: [
  ...
  },
  {
    ...
    name: 'Enterprise',
    highlight: false,
    description: 'สำหรับเชนศูนย์ความงามหรือองค์กรขนาดใหญ่ ที่ต้องการเชื่อมต่อข้อมูลหลายสาขา',
    price: 'Customized',
    badge: 'สำหรับองค์กร',
    maxSalesUsers: null,
    features: [
      ...
      <main className="flex-1 relative overflow-hidden">
        ...
        <div className="container relative z-10 py-12 md:py-20 px-6 space-y-16 max-w-7xl mx-auto">
          ...
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            >
              Select the optimal resource allocation node for your aesthetic orchestration and sales force optimization.
            </motion.p>
          </div>
          ...
          >
            <Card className="border-white/5 bg-white/[0.01] backdrop-blur-3xl rounded-[3rem] overflow-hidden shadow-2xl relative">
              ...
              <CardHeader className="p-12 pb-6">
                ...
                <CardDescription className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 mt-2">Aesthetic Plan Specification parameters</CardDescription>
              </CardHeader>
