...
import { NeuralTerminal } from "@/components/effects/neural-terminal"
              ...
              <div className="container relative z-10">
                <div className="grid lg:grid-cols-12 gap-20 items-center">
                  ...
                  <motion.div 
                    ...
                    className="lg:col-span-7 rounded-[3.5rem] border border-white/5 bg-white/[0.01] p-12 lg:p-16 backdrop-blur-3xl shadow-[0_0_80px_-20px_rgba(16,185,129,0.15)] relative group overflow-hidden"
                  >
          ...
          <div className="container relative z-10 space-y-32">
            ...
            <div className="space-y-16">
              <div className="text-center space-y-4">
                <h3 className="text-2xl font-black text-white italic uppercase tracking-[0.3em]">{t('neuralTerminal.title')}</h3>
                <p className="text-slate-500 font-light italic">{t('neuralTerminal.subtitle')}</p>
              </div>
              <NeuralTerminal />
            </div>
          </div>
          ...
          <div className="container relative z-10">
            ...
            >
              ...
              <h2 className="text-5xl md:text-9xl font-bold tracking-tighter text-white leading-tight italic">
                {t('demo.selector.title')}<br />
                <span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent not-italic">{t('demo.selector.subtitle')}</span>
              </h2>
                  ...
                  <Card className="h-full border-white/5 bg-white/[0.01] backdrop-blur-3xl rounded-[3.5rem] overflow-hidden group hover:border-pink-500/30 transition-all duration-700 shadow-2xl relative">
                    ...
                    <div className="p-12 space-y-10">
                      ...
                      <div className="flex items-center gap-4 pt-4">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-pink-500 animate-pulse">{t('demo.selector.ai.cta')}</span>
                ...
                <Link href={lp("/demo/center")}>
                  <Card className="h-full border-white/5 bg-white/[0.01] backdrop-blur-3xl rounded-[3.5rem] overflow-hidden group hover:border-cyan-500/30 transition-all duration-700 shadow-2xl relative">
                    ...
                    <div className="p-12 space-y-10">
                      ...
                      <div className="flex items-center gap-4 pt-4">
                        <div className="h-px flex-1 bg-white/5" />
                        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-cyan-500 animate-pulse">{t('demo.selector.revenue.cta')}</span>
        ...
        <section className="relative py-48 overflow-hidden bg-[#020617]">
          ...
          <div className="container relative z-10">
            <motion.div 
              ...
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              className="mx-auto max-w-6xl text-center space-y-24"
            >
              <div className="space-y-10">
                ...
                <h2 className="text-6xl md:text-[10rem] font-bold tracking-tighter text-white leading-[0.85] italic uppercase">
              ...
              <div className="relative">
                <div className="absolute inset-0 bg-pink-500/5 blur-[120px] rounded-full -z-10" />
                <AINetworkTopology />
              </div>
