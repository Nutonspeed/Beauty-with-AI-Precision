...
export default function FluidBackground({
  ...
  useEffect(() => {
    ...
    const count = Math.floor(baseCount * (isMobile ? 0.65 : 1))
    ...
    cleanupsRef.current.push(() => document.removeEventListener("visibilitychange", visibilityHandler))
    ...
    if (pauseWhenOffscreen) {
      ...
      cleanupsRef.current.push(() => io.disconnect())
    }
  ...
  }, [focusSelector, focusAttraction, particleCount, intensity, hues, gradient, pauseWhenOffscreen, autoThrottle, accentHue, accentAmount])
