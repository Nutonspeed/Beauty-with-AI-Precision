...
const SIMULATOR_TRANSLATIONS = {
  en: {
    ...
    presetDescription: 'Select a program intensity preset or customize individual effects'
  },
  th: {
    title: 'จำลองโปรแกรมความงาม',
    custom: 'กำหนดเอง',
    mild: 'เบา',
    moderate: 'ปานกลาง',
    intensive: 'เข้มข้น',
    ...
    presetDescription: 'เลือกระดับโปรแกรมหรือปรับแต่งแต่ละเอฟเฟกต์'
  }
};

export interface ProgramSimulatorProps {
  ...
  const handleExport = useCallback(async () => {
    ...
    try {
      ...
      if (onExport) {
        ...
        a.href = url;
        a.download = `program-result-${Date.now()}.png`;
        a.click();
      ...
      <div className="p-6">
        ...
        <Tabs value={currentPreset} onValueChange={(value) => {
          ...
          <TabsContent value="mild" className="mt-4">
            <div className="p-4 bg-muted rounded-lg text-center">
              <p className="text-sm text-muted-foreground">
                Mild program preset applied. Switch to Custom tab to adjust.
              </p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="moderate" className="mt-4">
            <div className="p-4 bg-muted rounded-lg text-center">
              <p className="text-sm text-muted-foreground">
                Moderate program preset applied. Switch to Custom tab to adjust.
              </p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="intensive" className="mt-4">
            <div className="p-4 bg-muted rounded-lg text-center">
              <p className="text-sm text-muted-foreground">
                Intensive program preset applied. Switch to Custom tab to adjust.
              </p>
            </div>
          </TabsContent>
        </Tabs>
