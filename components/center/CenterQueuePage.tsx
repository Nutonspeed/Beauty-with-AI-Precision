...
interface CenterQueueProps {
  centerId: string;
  initialQueue?: QueueItem[];
}

export function CenterQueuePage({ centerId, initialQueue = [] }: CenterQueueProps) {
  ...
  return (
    <div className="container mx-auto py-8">
      <ChannelSubscriber
        channels={[channels.center.queue(centerId)]}
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Live queue for center {centerId}
              </CardDescription>
            </div>
