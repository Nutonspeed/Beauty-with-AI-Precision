    ...
    try {
      ...
      try {
        const resultsPayload = {
          ...
          metrics: {
            wrinkles: { score: 78, grade: 'B', trend: 'up', description_en: t('metrics.wrinkles.desc'), description_th: t('metrics.wrinkles.desc') },
            spots: { score: 74, grade: 'B', trend: 'stable', description_en: t('metrics.spots.desc'), description_th: t('metrics.spots.desc') },
            pores: { score: 70, grade: 'B', trend: 'down', description_en: t('metrics.pores.desc'), description_th: t('metrics.pores.desc') },
            texture: { score: 85, grade: 'A', trend: 'up', description_en: t('metrics.texture.desc'), description_th: t('metrics.texture.desc') },
            evenness: { score: 80, grade: 'B', trend: 'stable', description_en: t('metrics.evenness.desc'), description_th: t('metrics.evenness.desc') },
            firmness: { score: 76, grade: 'B', trend: 'up', description_en: t('metrics.firmness.desc'), description_th: t('metrics.firmness.desc') },
            radiance: { score: 83, grade: 'A', trend: 'up', description_en: t('metrics.radiance.desc'), description_th: t('metrics.radiance.desc') },
            hydration: { score: 79, grade: 'B', trend: 'stable', description_en: t('metrics.hydration.desc'), description_th: t('metrics.hydration.desc') },
          },
          recommendations: [
            { title_en: t('recDetails.sunscreen.title'), title_th: t('recDetails.sunscreen.title'), description_en: t('recDetails.sunscreen.desc'), description_th: t('recDetails.sunscreen.desc'), priority: 'high' },
            { title_en: t('recDetails.moisturizer.title'), title_th: t('recDetails.moisturizer.title'), description_en: t('recDetails.moisturizer.desc'), description_th: t('recDetails.moisturizer.desc'), priority: 'medium' },
            { title_en: t('recDetails.retinoids.title'), title_th: t('recDetails.retinoids.title'), description_en: t('recDetails.retinoids.desc'), description_th: t('recDetails.retinoids.desc'), priority: 'low' },
          ],
