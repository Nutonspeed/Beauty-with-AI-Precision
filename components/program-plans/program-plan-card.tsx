...
export function ProgramPlanCard({ plan, onUpdate: _onUpdate }: ProgramPlanCardProps) {
  const totalSessions = plan.programs.reduce((sum, p) => sum + p.sessions, 0)
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <Button asChild className="w-full">
          <Link href={`/program-plans/${plan.id}`}>
