...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "focus:bg-pink-50 focus:text-pink-600 data-[variant=destructive]:text-rose-600 data-[variant=destructive]:focus:bg-rose-50 data-[variant=destructive]:focus:text-rose-600 [&_svg:not([class*='text-'])]:text-slate-400 relative flex cursor-pointer items-center gap-3 rounded-xl px-4 py-3 text-[10px] font-black uppercase tracking-widest italic outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-10 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 transition-colors duration-300",
        className,
      )}
      {...props}
    />
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn('bg-slate-100 -mx-1 my-2 h-px', className)}
      {...props}
    />
  )
}
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-pink-50 focus:text-pink-600 data-[state=open]:bg-pink-50 data-[state=open]:text-pink-600 [&_svg:not([class*='text-'])]:text-slate-400 relative flex cursor-pointer items-center gap-3 rounded-xl px-4 py-3 text-[10px] font-black uppercase tracking-widest italic outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-10 transition-colors duration-300",
        className,
      )}
      {...props}
    >
