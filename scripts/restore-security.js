...
const targetPath = path.resolve('d:/127995803/Beauty-with-AI-Precision/lib/security/security-manager.ts');
...
`;
fs.writeFileSync('d:/127995803/Beauty-with-AI-Precision/lib/security/security-manager.ts', content);
console.log('Successfully restored SecurityManager');
`
fs.writeFileSync('d:/127995803/Beauty-with-AI-Precision/scripts/restore-security.js', restorationScript);
