-- สร้างข้อมูลทดสอบสำหรับ Beauty AI Precision (Fixed)
-- รันใน Supabase SQL Editor

-- 1. สร้างคลินิกทดสอบ (ใช้เฉพาะคอลัมน์ที่มีจริง)
INSERT INTO clinics (
    name, 
    email, 
    phone, 
...
-- 8. สร้างวันหยุด (ถ้ามีตาราง clinic_holidays)
DO $$
BEGIN
    IF EXISTS (
        SELECT FROM information_schema.tables 
        WHERE table_schema = 'public' 
        AND table_name = 'clinic_holidays'
    ) THEN
