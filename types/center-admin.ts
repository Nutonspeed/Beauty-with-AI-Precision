// ============================================================================
// Phase 5: Center Admin Dashboard - TypeScript Type Definitions
// ============================================================================
...
export interface CustomerNote {
  ...
  note_type: 'general' | 'program' | 'concern' | 'follow_up' | 'complaint';
  content: string;
...
export interface CenterStatsCache {
  id: string;
  center_id: string;
...
export interface EnhancedAppointment {
  ...
  service_id: string | null; // New: link to center_services
  service_type: string;
  appointment_date: string;
...
export interface EnhancedStaffMember {
  ...
  center_id: string;
  user_id: string;
  role: 'center_owner' | 'manager' | 'sales_staff' | 'receptionist' | 'therapist';
...
export interface EnhancedCustomer {
  ...
  program_plans?: any[]; // Reference to existing type
}
