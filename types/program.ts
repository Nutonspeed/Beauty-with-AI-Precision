/**
 * Program Recommendation Types
 * Phase 3: Program database and recommendation engine
 */
...
export interface RecommendationResult {
  recommended_programs: ProgramRecommendation[]
  recommended_packages: ProgramPackage[]
